      ...
      <div className="w-full max-w-6xl mx-auto mb-8 relative">
        <div
          className={`relative overflow-hidden rounded-2xl shadow-2xl border-2 transition-all duration-500 ${
            ...
            isDragging
              ? "border-[#1eb5ee] bg-[#1eb5ee]/20 scale-105"
          ...
          style={{
            ...
            minHeight: "200px",
            borderColor: isDragging ? "#1eb5ee" : "rgba(0, 214, 214, 0.3)",
          }}
        ...
        >
          ...
          <div className="absolute inset-0 opacity-30">
            <div className="absolute top-4 left-4 w-3 h-3 bg-[#1eb5ee] rounded-full animate-ping"></div>
            <div className="absolute top-8 right-8 w-2 h-2 bg-[#38bdf8] rounded-full animate-bounce delay-300"></div>
            <div className="absolute bottom-6 left-8 w-2.5 h-2.5 bg-[#1eb5ee] rounded-full animate-pulse delay-500"></div>
            <div className="absolute bottom-4 right-4 w-3 h-3 bg-[#22c55e] rounded-full animate-ping delay-700"></div>
          </div>
          ...
          <div className="relative z-10 p-8 text-center">
            <div className="flex flex-col items-center space-y-6">
              ...
              <div
                ...
                style={{
                  background: isDragging
                    ? "linear-gradient(135deg, #1eb5ee 0%, #38bdf8 100%)"
                    : "linear-gradient(135deg, rgba(0, 214, 214, 0.3) 0%, rgba(112, 211, 213, 0.3) 100%)",
                }}
              >
                <svg
                  className={`w-10 h-10 transition-all duration-500 ${
                    isDragging ? "text-white animate-bounce" : "text-[#1eb5ee]"
                  }`}
                  fill="none"
                  stroke="currentColor"
                  viewBox="0 0 24 24"
              ...
              <div className="space-y-2">
                <h3
                  ...
                  style={{
                    color: isDragging ? "#38bdf8" : "#1eb5ee",
                  }}
                >
                  ...
                  <span
                    ...
                    style={{
                      background: isDragging
                        ? "rgba(0, 214, 214, 0.3)"
                        : "#e0f7f7",
                      color: isDragging ? "#38bdf8" : "#1c2631",
          ...
          >
            ...
            <div className="flex justify-center mb-6">
              <div
                ...
                style={{
                  background:
                    "linear-gradient(135deg, #1eb5ee 0%, #00b8b8 100%)",
                }}
              >
                <svg
...
const SessionControl = ({ sessionId, onStart, onEnd, user }) => {
  ...
  return (
    <div className="w-full max-w-6xl mx-auto mb-8 relative">
            ...
            <div className="flex items-center gap-3">
              <div className="relative">
                <div
                  ...
                  style={{
                    background: sessionId ? "#1eb5ee" : "#f59e0b",
                  }}
                >
                  {sessionId && (
                    <div
              ...
              <div>
                ...
                <p className="text-gray-600 text-xs">
                  Session ID:{" "}
                  <span className="font-mono text-[#1eb5ee] px-2 py-0.5 rounded bg-gray-100 text-xs">
                    {sessionId
      ...
      {!user && (
        <div
          className="relative mt-6 p-6 rounded-2xl shadow-xl border border-[#1eb5ee]/30 transition-all duration-500 transform hover:scale-[1.01] animate-fadeIn"
          style={{
            background:
        ...
        >
          ...
          <div className="space-y-3 ml-16">
            <div className="flex items-start gap-3">
              <div className="w-1.5 h-1.5 rounded-full bg-[#1eb5ee] mt-2 flex-shrink-0"></div>
          ...
          {/* Call to Action */}
          <div className="mt-6 pt-6 border-t border-[#1eb5ee]/20">
    ...
    >
      ...
      <div className="relative z-10 w-full px-6 py-8">
        ...
        >
          ...
          >
            <span className="inline-block" style={{ color: "#1eb5ee" }}>
              NOVA
            </span>
              ...
              <div className="flex gap-3">
                {user?.role === 'read_only_user' ? (
                  <button
                    ...
                    style={{
                      background: "linear-gradient(135deg, #1eb5ee, #00b8b8)",
                ...
                <Link
                  to="/chat"
                  className="px-6 py-3 rounded-xl font-bold text-[#1eb5ee] border-2 border-[#1eb5ee] transition-all duration-300 transform hover:scale-105 hover:bg-[#1eb5ee]/10"
                  style={{
        ...
        >
          {/* Main Title Card */}
          <div
            className="relative mb-6 p-6 rounded-2xl shadow-xl border border-[#1eb5ee]/30 text-center"
            style={{
              background: "#e0f2fe",
            }}
          >
          ...
          <div className="mb-16">
            ...
            <div className="text-center mb-12">
              <div className="inline-flex items-center justify-center w-16 h-16 rounded-2xl bg-gradient-to-br from-[#1eb5ee] to-sky-600 mb-6">
              ...
              <p className="text-2xl md:text-3xl font-bold text-[#1eb5ee] mb-4">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 mb-12">
              ...
              <div
                className="relative p-8 rounded-2xl border border-[#1eb5ee]/30 shadow-lg"
                style={{
                  background: "linear-gradient(145deg, #f0f9ff 0%, #e0f2fe 100%)",
                }}
              >
                <div className="flex items-center gap-3 mb-6">
                  <div className="w-12 h-12 rounded-xl bg-gradient-to-br from-[#1eb5ee]/20 to-sky-500/20 flex items-center justify-center">
                ...
                <ul className="space-y-4">
                  {[
                    ...
                    <li key={index} className="flex items-start gap-3">
                      <div className="flex-shrink-0 w-6 h-6 rounded-full bg-[#1eb5ee]/20 flex items-center justify-center mt-0.5">
              ...
              {/* Azure Card */}
              <div
                className="relative p-8 rounded-2xl border border-[#1eb5ee]/30 shadow-lg flex flex-col"
                style={{
                  background: "linear-gradient(145deg, #f0f9ff 0%, #e0f2fe 100%)",
                }}
              >
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
              {[
                ...
                <div
                  key={index}
                  className="relative p-6 rounded-xl border border-[#1eb5ee]/20 transition-all duration-300 hover:shadow-lg hover:border-[#1eb5ee]/40"
                  style={{
                    background: "#e0f2fe",
                  }}
                >
                  <div className="flex items-center gap-3 mb-3">
                    <div className="w-10 h-10 rounded-lg bg-[#1eb5ee]/10 flex items-center justify-center">
                      {card.icon}
                    </div>
            ...
            <div className="mt-12 text-center">
              <div
                className="inline-flex items-center gap-3 px-6 py-3 rounded-full border border-[#1eb5ee]/30"
                style={{ background: "#e0f2fe" }}
              >
                <div className="w-3 h-3 rounded-full bg-[#1eb5ee] animate-pulse"></div>
      ...
      >
        <div
          ...
          style={{
            background: "linear-gradient(135deg, #1eb5ee 0%, #00B4B4 100%)",
          }}
        >
          <svg
              ...
              <RestrictedSubdomainRedirect path="/chat">
                <ProtectedRoute>
                  <div className="h-screen flex flex-col overflow-hidden">
                    <Navbar user={user} setUser={setUser} />
                    <div className="flex-1 min-h-0 pt-14 overflow-hidden">
                      <ChatWidget
                        key={chatWidgetKey}
                        sessionId={sessionId}
                        user={user}
