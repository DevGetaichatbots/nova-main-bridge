        ...
        >
          <form className="space-y-5" onSubmit={handleSubmit}>
              ...
              {formData.password && (
                <div className="mt-2">
                  <div className="flex items-center justify-between mb-1">
                    ...
                    <span className="text-xs font-medium" style={{ color: getPasswordStrength() <= 2 ? "#ef4444" : getPasswordStrength() <= 3 ? "#eab308" : "#1eb5ee" }}>
                      {getStrengthText()}
                    </span>
                  </div>
                  <div className="w-full rounded-full h-2" style={{ backgroundColor: "#e2e8f0" }}>
                    <div
                      ...
                      style={{
                        ...
                        backgroundColor: getPasswordStrength() <= 2 ? "#ef4444" : getPasswordStrength() <= 3 ? "#eab308" : "#1eb5ee"
                      }}
                    ></div>
                  </div>
                </div>
            ...
            <div className="flex items-start gap-3">
              <input
                ...
                onChange={handleInputChange}
                className="w-5 h-5 mt-0.5 rounded border-gray-300 text-[#1eb5ee] focus:ring-[#1eb5ee]"
              />
          ...
          <div className="mt-6 text-center">
            <p className="text-sm" style={{ color: "#64748b" }}>
              {t('signup.hasAccount')}{" "}
              <Link to="/login" className="font-semibold hover:underline" style={{ color: "#1eb5ee" }}>
                {t('signup.loginLink')}
              </Link>
            </p>
          </div>
