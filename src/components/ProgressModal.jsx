    ...
    <div className="fixed inset-0 z-[10000] flex items-center justify-center">
      ...
      >
        ...
        <div
          ...
          style={{
            background: error ? "#dc2626" : "#1eb5ee",
            borderColor: "rgba(0, 214, 214, 0.3)",
          }}
        >
        ...
        {/* Enhanced Content */}
        <div className="p-8" style={{backgroundColor: "#f0f9ff"}}>
          {error ? (
            /* Error State */
            ...
            <div className="text-center">
              <div className="relative w-24 h-24 mx-auto mb-6">
                ...
                <div
                  ...
                  style={{ animationDuration: "2s", borderTopColor: "#1eb5ee" }}
                ></div>
                <div
                  ...
                  style={{
                    ...
                    borderRightColor: "#1eb5ee"
                  }}
                ></div>
                <div className="absolute inset-0 flex items-center justify-center">
                  <div className="w-8 h-8 rounded-full animate-pulse flex items-center justify-center" style={{backgroundColor: "#1eb5ee"}}>
                    <svg
              ...
              <div className="mb-6">
                <p className="font-semibold text-lg mb-2" style={{color: "#1eb5ee"}}>
              ...
              <div className="relative mb-6">
                ...
                <div className="flex justify-between items-center">
                  <span className="text-lg font-bold" style={{color: "#1eb5ee"}}>
                    {Math.round(displayProgress)}%
                  </span>
                  {displayProgress >= 90 && (
                    <span className="text-sm font-medium animate-pulse" style={{color: "#1eb5ee"}}>
