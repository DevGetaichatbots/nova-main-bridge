  ...
  const renderProcessing = () => {
    ...
    const renderScanIcon = () => (
      <div className="relative w-16 h-16 mx-auto mb-6">
        <div className="absolute inset-0 rounded-2xl bg-[#1eb5ee]/8 animate-ping" style={{ animationDuration: '2.5s' }} />
        <div className="relative w-16 h-16 rounded-2xl bg-gradient-to-br from-[#1eb5ee] to-[#00B4B4] flex items-center justify-center shadow-lg shadow-[#1eb5ee]/25">
    ...
    const renderThinkingIcon = () => (
      <div className="relative w-20 h-20 mx-auto mb-6">
        {[0, 1, 2].map(i => (
          ...
          >
            <div
              className="absolute rounded-full bg-[#1eb5ee]"
              style={{
                width: `${6 - i}px`,
                height: `${6 - i}px`,
                top: '-3px',
        ...
        <div className="absolute inset-2 rounded-full bg-gradient-to-br from-[#1eb5ee] to-[#00B4B4] flex items-center justify-center shadow-lg shadow-[#1eb5ee]/30">
