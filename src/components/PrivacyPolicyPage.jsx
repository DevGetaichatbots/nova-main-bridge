  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-slate-50 to-white flex flex-col">
      ...
      <div className="max-w-4xl mx-auto px-6 py-12 flex-1">
        ...
        <div className="bg-white rounded-2xl border border-gray-100 p-8 mb-8 shadow-sm hover:shadow-lg hover:border-[#1eb5ee]/20 transition-all duration-300">
          <div className="flex items-start gap-4 mb-6">
            <div className="w-10 h-10 rounded-xl bg-[#1eb5ee]/10 flex items-center justify-center flex-shrink-0">
          ...
          <div className="space-y-4 ml-14">
            {['contact', 'project', 'technical', 'usage'].map((item) => (
              <div key={item} className="flex items-start gap-3">
                <div className="w-5 h-5 rounded-full bg-[#1eb5ee]/20 flex items-center justify-center flex-shrink-0 mt-0.5">
                  <svg className="w-3 h-3 text-[#1eb5ee]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <div className="bg-white rounded-2xl border border-gray-100 p-8 mb-8 shadow-sm hover:shadow-lg hover:border-[#1eb5ee]/20 transition-all duration-300">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4 ml-14">
            {['service', 'communication', 'security', 'analysis'].map((item) => (
              <div key={item} className="bg-gray-50 rounded-xl p-4 border-l-4 border-[#1eb5ee]/30">
        ...
        <div className="bg-white rounded-2xl border border-gray-100 p-8 mb-8 shadow-sm hover:shadow-lg hover:border-[#1eb5ee]/20 transition-all duration-300">
          ...
          <div className="mt-6 ml-14 p-4 bg-[#e0f2fe] rounded-xl border border-[#1eb5ee]/20">
            <p className="text-gray-700 text-sm">{t('privacy.contactRights')}</p>
            <a href="mailto:info@nordicaigroup.com" className="text-[#1eb5ee] font-semibold hover:underline">info@nordicaigroup.com</a>
          </div>
        </div>
        ...
        <div className="bg-white rounded-2xl border border-gray-100 p-8 mb-8 shadow-sm hover:shadow-lg hover:border-[#1eb5ee]/20 transition-all duration-300">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4 ml-14">
            {['ssl', 'access', 'hosting', 'backup'].map((item) => (
              <div key={item} className="flex items-start gap-3">
                <div className="w-8 h-8 rounded-lg bg-[#1eb5ee]/10 flex items-center justify-center flex-shrink-0">
        ...
        <div className="bg-gradient-to-br from-[#e0f2fe] to-white rounded-2xl border border-[#1eb5ee]/20 p-8 mb-8 text-center">
          ...
          <a 
            ...
            className="inline-flex items-center gap-2 px-5 py-2.5 bg-[#1eb5ee] text-white font-semibold rounded-xl hover:bg-[#00C4C4] transition-all duration-300"
          >
