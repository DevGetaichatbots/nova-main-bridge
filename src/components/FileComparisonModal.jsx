    ...
    <>
                ...
                <div className="space-y-4 p-5 rounded-2xl border" style={{ backgroundColor: "rgba(0,214,214,0.06)", borderColor: "rgba(0,214,214,0.25)" }}>
                  ...
                  <div className="flex items-center justify-between">
                    <span className="text-sm font-semibold flex items-center gap-2" style={{ color: "#1c2631" }}>
                      {uploadProgressData.overall_progress >= 100 ? (
                        <svg className="w-4 h-4" style={{ color: "#1eb5ee" }} fill="none" stroke="currentColor" viewBox="0 0 24 24">
                          <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 13l4 4L19 7" />
                        </svg>
                      ) : (
                        <svg className="w-4 h-4 animate-spin" style={{ color: "#1eb5ee" }} fill="none" viewBox="0 0 24 24">
                    ...
                    <span className="text-sm font-bold" style={{ color: "#1eb5ee" }}>
                  ...
                  <div className="w-full h-2.5 bg-gray-200 rounded-full overflow-hidden">
                    <div
                      ...
                      style={{ width: `${uploadProgressData.overall_progress || 0}%`, background: "linear-gradient(90deg, #1eb5ee, #38bdf8)" }}
                    />
                  </div>
                    ...
                    {[
                      ...
                      <div key={key} className="rounded-xl p-4 border space-y-2" style={{ backgroundColor: "rgba(255,255,255,0.7)", borderColor: "rgba(0,214,214,0.2)" }}>
                        <div className="flex items-center justify-between gap-2">
                          ...
                          <span className="text-xs font-bold flex-shrink-0" style={{ color: "#1eb5ee" }}>{Math.round(data?.progress || 0)}%</span>
                        </div>
                        ...
                        <div className="w-full h-1.5 bg-gray-100 rounded-full overflow-hidden">
                          <div
                            ...
                            style={{ width: `${data?.progress || 0}%`, background: data?.step === 'complete' ? '#1eb5ee' : 'linear-gradient(90deg, #1eb5ee, #38bdf8)' }}
                          />
                        </div>
                      </div>
                    ))}
      ...
      <style jsx>{`
        ...
        .custom-scrollbar::-webkit-scrollbar-thumb {
          background: linear-gradient(135deg, #1eb5ee 0%, #1eb5ee 100%);
          border-radius: 10px;
          border: 2px solid rgba(30, 41, 59, 0.5);
        }
        .custom-scrollbar {
          scrollbar-width: thin;
          scrollbar-color: #1eb5ee rgb(234, 250, 250);
        }
      `}</style>
    </>,
    modalRoot
