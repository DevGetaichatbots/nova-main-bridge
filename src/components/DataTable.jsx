...
const DataTable = ({ title, data, icon }) => {
  ...
  const headerGradient = "from-sky-500 to-sky-600";
  ...
  return (
    <div className=" animate-fade-in">
      ...
      <div
        className="relative overflow-hidden rounded-2xl shadow-2xl border border-[#1eb5ee]/30"
      ...
      >
          ...
          <table className="w-full min-w-[1600px]">
            ...
            >
              {data.map((row, index) => (
                <tr
                  key={index}
                  className="hover:bg-sky-50/50 transition-all duration-300 group"
                >
                  <td className="px-6 py-4 whitespace-nowrap text-sm font-mono font-bold text-[#1eb5ee] group-hover:text-sky-600">
                    {row.id || "N/A"}
                  </td>
                  <td
        ...
        <div
          className="px-6 py-3 border-t border-[#1eb5ee]/30"
