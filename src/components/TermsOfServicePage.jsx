          ...
          <div className="ml-14 space-y-4">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
              {['payment1', 'payment2', 'payment3', 'payment4'].map((item) => (
                <div key={item} className="bg-gray-50 rounded-xl p-3 border-l-4 border-[#1eb5ee]/30">
                  <p className="text-gray-600 text-sm">{t(`terms.${item}`)}</p>
                </div>
              ))}
            </div>
        ...
        <div className="bg-gradient-to-br from-[#e0f2fe] to-white rounded-2xl border border-[#1eb5ee]/20 p-8 mb-8 text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-3 justify-center">
            <a 
              ...
              className="inline-flex items-center justify-center gap-2 px-5 py-2.5 bg-[#1eb5ee] text-white font-semibold rounded-xl hover:bg-[#00C4C4] transition-all duration-300"
            >
