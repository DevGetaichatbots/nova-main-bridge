            ...
            {user ? (
              ...
              <div className="relative user-menu-container">
                <button
                  ...
                  className="group flex items-center gap-2 px-3 py-2 rounded-lg text-sm font-medium transition-all duration-300 border border-[#1eb5ee] hover:border-[#1eb5ee]/80"
                  style={{
                    background: "#e0f4fd",
                  }}
                >
                  ...
                  >
                    ...
                    <div className="py-2">
                      <button
                        ...
                        className="w-full flex items-center gap-3 px-4 py-2 text-gray-700 hover:text-[#1eb5ee] hover:bg-gray-50 transition-all duration-200"
                      >
                        <svg
                          className="w-5 h-5"
                          fill="none"
              ...
              <>
                ...
                <Link
                  to="/login"
                  className="px-4 py-2 rounded-lg text-sm font-medium transition-all duration-300 border border-gray-200 hover:border-gray-300"
                  style={{
                    background: "#ffffff",
                    color: "#1c2631",
                  }}
                ...
                <Link
                  to="/signup"
                  className="px-4 py-2 rounded-lg text-sm font-medium transition-all duration-300 text-white hover:opacity-90"
                  style={{
                    background: "#1eb5ee",
                  }}
                >
