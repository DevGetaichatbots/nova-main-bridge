...
export default function SuperAdminPortal() {
  ...
  const StatCard = ({ title, value, subtitle, icon, color = 'sky' }) => (
    <div className="bg-white/80 backdrop-blur-sm rounded-2xl p-6 shadow-lg border border-gray-100 hover:shadow-xl transition-all duration-300">
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className={`text-3xl font-bold mt-1 ${color === 'sky' ? 'text-[#1eb5ee]' : `text-${color}-600`}`}>{value}</p>
          {subtitle && <p className="text-gray-400 text-xs mt-1">{subtitle}</p>}
        </div>
        <div className={`w-14 h-14 rounded-xl flex items-center justify-center ${color === 'sky' ? 'bg-[#e0f2fe]' : `bg-${color}-100`}`}>
  ...
  const RoleBadge = ({ role }) => {
    const colors = {
      ...
      company_owner: 'bg-[#e0f2fe] text-sky-800 border-sky-200',
  ...
  if (loading) {
    return (
      <div className="min-h-screen bg-gradient-to-br from-gray-50 via-sky-50/30 to-gray-100 flex items-center justify-center">
        <div className="flex flex-col items-center gap-4">
          <div className="w-12 h-12 border-4 border-[#1eb5ee] border-t-transparent rounded-full animate-spin"></div>
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-50 via-sky-50/30 to-gray-100 pt-14">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div className="mb-8">
          <div className="flex items-center gap-3 mb-2">
            <div className="w-12 h-12 bg-gradient-to-br from-[#1eb5ee] to-[#17a3d4] rounded-xl flex items-center justify-center shadow-lg">
          ...
          {['dashboard', 'management', 'audit', 'chats'].map((tab) => (
            <button
              ...
              className={`px-6 py-2.5 rounded-lg font-medium transition-all duration-200 ${
                activeTab === tab
                  ? 'bg-gradient-to-r from-[#1eb5ee] to-[#17a3d4] text-white shadow-md'
              ...
              <div className="bg-white/80 backdrop-blur-sm rounded-2xl p-6 shadow-lg border border-gray-100">
                <div className="flex items-center justify-between mb-4">
                  ...
                  <select
                    ...
                    className="px-3 py-1.5 rounded-lg border border-gray-200 text-sm text-gray-700 focus:outline-none focus:ring-2 focus:ring-sky-100 focus:border-sky-400 bg-white cursor-pointer"
                  >
                  ...
                  {dashboard.recentCompanies.map((company) => (
                    <div key={company.id} className="flex items-center justify-between p-3 bg-gray-50 rounded-xl">
                      ...
                      <div className="text-right">
                        <p className="text-sm font-semibold text-[#1eb5ee]">{company.userCount} {t('superAdmin.users')}</p>
                ...
                <div className="flex items-center justify-between pt-4 border-t border-gray-100 mt-2">
                  ...
                  <div className="flex items-center gap-2">
                    <button
                      ...
                      className={`p-2 rounded-lg border transition-all ${recentUsersPage <= 1 ? 'border-gray-100 text-gray-300 cursor-not-allowed' : 'border-gray-200 text-gray-600 hover:bg-[#f0f9ff] hover:border-sky-300 hover:text-[#1eb5ee]'}`}
                    >
                    ...
                    <button
                      ...
                      className={`p-2 rounded-lg border transition-all ${recentUsersPage >= dashboard.recentUsersPagination.totalPages ? 'border-gray-100 text-gray-300 cursor-not-allowed' : 'border-gray-200 text-gray-600 hover:bg-[#f0f9ff] hover:border-sky-300 hover:text-[#1eb5ee]'}`}
                    >
                ...
                <div className="p-4 border-b border-gray-100">
                  <div className="flex items-center justify-between mb-3">
                    ...
                    <button
                      ...
                      className="px-3 py-1.5 bg-gradient-to-r from-[#1eb5ee] to-[#17a3d4] text-white rounded-lg text-sm font-medium hover:from-[#17a3d4] hover:to-[#1293bf] transition-all flex items-center gap-1"
                    >
                  ...
                  <div className="relative">
                    <input
                      ...
                      className="w-full pl-9 pr-4 py-2 rounded-lg border border-gray-200 focus:border-sky-400 focus:ring-2 focus:ring-sky-100 transition-all text-sm"
                    />
                  ...
                  <button
                    ...
                    className={`w-full p-4 text-left border-b border-gray-100 transition-all ${
                      selectedCompanyId === null 
                        ? 'bg-[#f0f9ff] border-l-4 border-l-[#1eb5ee]' 
                        : 'hover:bg-gray-50'
                    }`}
                  >
                    <div className="flex items-center justify-between">
                      <div className="flex items-center gap-3">
                        <div className="w-10 h-10 rounded-xl bg-gradient-to-br from-[#1eb5ee] to-[#17a3d4] flex items-center justify-center text-white text-lg">
                          👥
                        </div>
                        <div>
                      ...
                      <span className="px-2 py-1 bg-[#e0f2fe] text-[#1293bf] rounded-full text-xs font-semibold">
                ...
                {companiesPagination && companiesPagination.totalPages > 1 && (
                  <div className="p-3 border-t border-gray-100 flex items-center justify-between">
                    ...
                    <button
                      ...
                      className="px-3 py-1.5 rounded-lg bg-[#1eb5ee] text-white hover:bg-[#17a3d4] disabled:opacity-50 disabled:cursor-not-allowed text-xs"
                    >
                      →
                    </button>
                  </div>
                ...
                <div className="p-4 border-b border-gray-100">
                  ...
                  <div className="flex flex-col sm:flex-row gap-3 mt-4">
                    ...
                    <select
                      ...
                      className="px-3 py-2 rounded-lg border border-gray-200 focus:border-sky-400 focus:ring-2 focus:ring-sky-100 transition-all bg-white text-sm"
                    >
                  ...
                  <table className="w-full">
                    ...
                    <tbody>
                      {usersLoading ? (
                        ...
                        users.map((user) => (
                          <tr key={user.id} className="border-b border-gray-100 hover:bg-[#f0f9ff]/30 transition-colors">
                  ...
                  <div className="flex items-center justify-between px-4 py-3 bg-gray-50 border-t border-gray-100">
                    ...
                    <div className="flex gap-2">
                      ...
                      <button
                        ...
                        className="px-3 py-1.5 rounded-lg bg-[#1eb5ee] text-white hover:bg-[#17a3d4] disabled:opacity-50 disabled:cursor-not-allowed text-sm"
                      >
                        {t('common.next')}
                      </button>
                    </div>
          ...
          <div className="bg-white/80 backdrop-blur-sm rounded-2xl shadow-lg border border-gray-100">
            <div className="p-6 border-b border-gray-100">
              <div className="flex justify-between items-center">
                ...
                <button
                  ...
                  className="px-6 py-2.5 rounded-lg bg-gradient-to-r from-[#1eb5ee] to-[#17a3d4] text-white font-medium flex items-center gap-2 hover:shadow-lg transition-all"
                >
              ...
              <div className="flex flex-wrap gap-4 mt-4">
                <div className="relative">
                  <input
                    ...
                    className="px-4 py-2 pl-10 rounded-lg border border-gray-200 focus:outline-none focus:ring-2 focus:ring-[#1eb5ee]/50 w-64"
                  />
                ...
                <select
                  ...
                  className="px-4 py-2 rounded-lg border border-gray-200 focus:outline-none focus:ring-2 focus:ring-[#1eb5ee]/50"
                >
            ...
            {auditLoading ? (
              <div className="p-12 text-center">
                <div className="w-12 h-12 border-4 border-[#1eb5ee] border-t-transparent rounded-full animate-spin mx-auto mb-4"></div>
                      ...
                      <tr key={log.id} className="hover:bg-gray-50">
                        ...
                        <td className="px-6 py-4">
                          <span className={`px-3 py-1 rounded-full text-xs font-semibold ${
                            ...
                            log.eventType === 'chat_created' ? 'bg-[#e0f2fe] text-[#1293bf]' :
                            log.eventType === 'chat_renamed' ? 'bg-[#e0f2fe] text-[#1293bf]' :
                            ...
                            log.eventType === 'user_created' ? 'bg-[#e0f2fe] text-[#1293bf]' :
                            log.eventType === 'user_updated' ? 'bg-[#e0f2fe] text-[#1293bf]' :
              ...
              <div className="flex flex-wrap gap-4 mt-4">
                <div className="relative flex-1 max-w-sm">
                  <input
                    ...
                    className="w-full px-4 py-2 pl-10 rounded-lg border border-gray-200 focus:outline-none focus:ring-2 focus:ring-[#1eb5ee]/50"
                  />
                  <svg className="w-5 h-5 text-gray-400 absolute left-3 top-1/2 -translate-y-1/2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M21 21l-6-6m2-5a7 7 0 11-14 0 7 7 0 0114 0z" />
                  </svg>
                        ...
                        <td className="px-6 py-4">
                          <div className="flex gap-2">
                            <button
                              ...
                              className="px-4 py-2 rounded-lg bg-[#1eb5ee] text-white text-sm hover:bg-[#17a3d4]"
                            >
                              {t('companyPortal.viewChat')}
                            </button>
                            <button
                              onClick={() => handleExportSingleChat(session.id)}
                              className="px-3 py-2 rounded-lg border border-[#1eb5ee] text-[#1eb5ee] text-sm hover:bg-[#f0f9ff]"
        ...
        {selectedChatSession && (
          <div className="fixed inset-0 bg-black/50 backdrop-blur-sm flex items-center justify-center z-50 p-4" onClick={closeChatModal}>
            <div className="bg-white rounded-2xl shadow-2xl max-w-6xl w-full max-h-[90vh] overflow-hidden flex flex-col" onClick={e => e.stopPropagation()}>
              <div className="p-5 border-b border-gray-100 flex justify-between items-center bg-gradient-to-r from-[#1eb5ee] to-[#17a3d4]">
                <div>
                ...
                {chatMessagesLoading ? (
                  <div className="space-y-4 animate-pulse">
                    ...
                    <div className="flex justify-end">
                      <div className="max-w-[70%] bg-sky-200 rounded-2xl rounded-br-md h-12 w-48"></div>
                    </div>
                    <div className="flex justify-start">
                      <div className="max-w-[70%] bg-gray-200 rounded-2xl rounded-bl-md h-32 w-[500px]"></div>
                    </div>
                    <div className="flex justify-end">
                      <div className="max-w-[70%] bg-sky-200 rounded-2xl rounded-br-md h-12 w-36"></div>
                    </div>
                    <div className="flex justify-start">
                  ...
                  chatMessages.map((msg) => (
                    <div key={msg.id} className={`flex ${msg.senderType === 'user' ? 'justify-end' : 'justify-start'}`}>
                      <div className={`max-w-[80%] px-4 py-3 rounded-2xl ${
                        msg.senderType === 'user' 
                          ? 'bg-[#1eb5ee] text-white rounded-br-md' 
      ...
      {addCompanyModal.isOpen && (
        ...
        >
          <div 
            ...
            onClick={(e) => e.stopPropagation()}
          >
            <div className="p-6 border-b border-gray-100 bg-gradient-to-r from-sky-50 to-sky-100">
              <div className="flex items-center gap-3">
                <div className="w-12 h-12 rounded-xl bg-gradient-to-br from-[#1eb5ee] to-[#17a3d4] flex items-center justify-center text-white">
            ...
            <form onSubmit={handleCreateCompany} className="p-6 space-y-4">
              ...
              <div className="space-y-4">
                ...
                <div>
                  ...
                  <input
                    ...
                    className="w-full px-4 py-2.5 rounded-lg border border-gray-200 focus:border-sky-400 focus:ring-2 focus:ring-sky-100"
                ...
                <div>
                  ...
                  <div className="relative">
                    <input
                      ...
                      className="w-full px-4 py-2.5 rounded-lg border border-gray-200 focus:border-sky-400 focus:ring-2 focus:ring-sky-100 pr-10"
              ...
              <div className="flex gap-3 pt-4">
                ...
                <button
                  ...
                  className="flex-1 py-3 px-4 rounded-xl bg-gradient-to-r from-[#1eb5ee] to-[#17a3d4] text-white font-medium hover:from-[#17a3d4] hover:to-[#1293bf] transition-all disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center gap-2"
                >
                  {addCompanyLoading ? (
                    <>
                      <svg className="animate-spin h-5 w-5" viewBox="0 0 24 24">
