  ...
  return (
    <div className="w-full mt-4 animate-fade-in">
      <div className="bg-gradient-to-br from-slate-50 to-white border border-slate-200 rounded-xl shadow-lg overflow-hidden">
        <div 
          className="flex items-center justify-between px-5 py-4 bg-gradient-to-r from-[#1eb5ee]/10 to-transparent border-b border-slate-200 cursor-pointer"
          onClick={() => setIsExpanded(!isExpanded)}
        >
          <div className="flex items-center gap-3">
            <div className="w-10 h-10 rounded-lg bg-gradient-to-br from-[#1eb5ee] to-[#00B8B8] flex items-center justify-center shadow-md">
            ...
            <button
              ...
              className={`flex items-center gap-2 px-4 py-2 rounded-lg text-sm font-medium transition-all duration-200 ${
                copied 
                  ...
                  : 'bg-white border border-slate-200 text-slate-600 hover:bg-slate-50 hover:border-[#1eb5ee] hover:text-[#1eb5ee]'
              } shadow-sm`}
            >
              {copied ? (
                <>
              ...
              <div className="space-y-2">
                ...
                <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-5 gap-3">
                  {summary.overview.map((item, idx) => (
                    ...
                    >
                      <div className="text-2xl font-bold text-[#1eb5ee]">{item.count}</div>
              ...
              <div className="space-y-2">
                ...
                <div className="space-y-2">
                  {summary.dateShifts.map((shift, idx) => (
                    <div key={idx} className="flex items-center justify-between p-3 bg-sky-50/50 border border-sky-100 rounded-lg">
                ...
                <ul className="space-y-2">
                  {summary.rawBullets.map((bullet, idx) => (
                    <li key={idx} className="flex items-start gap-3 p-2">
                      <span className="flex-shrink-0 w-1.5 h-1.5 mt-2 rounded-full bg-[#1eb5ee]"></span>
