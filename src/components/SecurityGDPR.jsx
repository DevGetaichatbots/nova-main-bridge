      ...
      <div className="max-w-4xl mx-auto px-6 py-12">
        ...
        <div className="mb-12">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div className="bg-white rounded-xl border border-gray-100 p-6 hover:shadow-lg hover:scale-[1.02] hover:border-[#1eb5ee]/30 transition-all duration-300 cursor-pointer">
        ...
        <div className="mb-12">
          ...
          <div className="space-y-4">
            <div className="bg-white rounded-xl border-l-4 border-[#1eb5ee] p-6 shadow-sm hover:shadow-lg hover:translate-x-1 transition-all duration-300">
              <div className="flex items-center gap-3 mb-2">
                <div className="w-8 h-8 rounded-full bg-[#1eb5ee]/10 flex items-center justify-center">
        ...
        <div className="mb-12">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div className="bg-gradient-to-br from-[#e0f2fe] to-white rounded-xl border border-[#1eb5ee]/20 p-6">
        ...
        <div className="bg-gradient-to-br from-[#1c2631] to-[#2a3a4a] rounded-2xl p-8 text-white mb-8">
          ...
          <div className="bg-white/10 rounded-xl p-6">
            ...
            <div className="flex flex-col gap-2 mt-4">
              <a href="mailto:info@nordicaigroup.com" className="flex items-center gap-2 text-[#1eb5ee] hover:underline">
                <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" />
                </svg>
                info@nordicaigroup.com
              </a>
              <a href="tel:+4553721659" className="flex items-center gap-2 text-[#1eb5ee] hover:underline">
                <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
