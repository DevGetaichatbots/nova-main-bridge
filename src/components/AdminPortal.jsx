      ...
      {toast.show && (
        <div
          className={`fixed top-4 right-4 z-[9999] px-6 py-3 rounded-lg shadow-lg ${
            toast.type === "error" ? "bg-red-500" : "bg-[#1eb5ee]"
      ...
      <div className="max-w-7xl mx-auto px-4 py-8">
        <div className="flex items-center justify-between mb-8">
          <div className="flex items-center pt-28 gap-4">
            <div className="w-12 h-12 rounded-xl bg-[#1eb5ee] flex items-center justify-center">
              <svg
        ...
        <div className="bg-white rounded-2xl shadow-lg border border-[#1eb5ee]/20 overflow-hidden">
              ...
              <div className="flex flex-col sm:flex-row items-stretch sm:items-center gap-3">
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    className="pl-10 pr-4 py-2 rounded-lg border border-[#1eb5ee]/30 focus:ring-2 focus:ring-[#1eb5ee] focus:border-transparent outline-none w-full sm:w-64"
                  />
                  {searchInput && (
                    <button
                      onClick={() => {
                ...
                <button
                  ...
                  className="flex items-center justify-center gap-2 px-4 py-2 bg-[#1eb5ee] text-white rounded-lg hover:bg-[#00bfbf] transition-colors font-medium"
                >
                  <svg
                    className="w-5 h-5"
                    fill="none"
          ...
          <div className="overflow-x-auto">
            <table className="w-full">
              <thead className="bg-gradient-to-r from-[#1eb5ee] to-[#00bfbf]">
                <tr>
              ...
              <tbody className="divide-y divide-[#1eb5ee]/10">
                {users.map((user, index) => (
                  <tr
                    key={user.id}
                    className={`hover:bg-[#1eb5ee]/5 transition-colors ${
                      index % 2 === 0 ? "bg-white" : "bg-[#e0f7f7]/30"
                    }`}
                  >
                    <td className="px-6 py-4">
                      <div className="flex items-center gap-3 max-w-[200px]">
                        <div className="w-10 h-10 min-w-[40px] rounded-full bg-[#1eb5ee]/20 flex items-center justify-center">
                          <span className="text-[#1eb5ee] font-semibold text-sm">
                    ...
                    <td className="px-6 py-4">
                      <div className="flex items-center justify-end gap-2">
                        <button
                          ...
                          className="p-2 rounded-lg bg-[#1eb5ee]/10 text-[#1eb5ee] hover:bg-[#1eb5ee]/20 transition-colors"
                          title={t('admin.edit')}
                        >
                          <svg
                            className="w-5 h-5"
          ...
          {pagination.totalPages > 1 && (
            <div className="px-6 py-4 border-t border-[#1eb5ee]/20 bg-gradient-to-r from-[#e0f7f7]/30 to-white">
                  ...
                  <button
                    ...
                    className={`p-2 rounded-lg transition-colors ${
                      pagination.hasPrevPage
                        ? "bg-[#1eb5ee]/10 text-[#1eb5ee] hover:bg-[#1eb5ee]/20"
                  ...
                  <div className="flex items-center gap-1">
                    {pagination.page > 3 && pagination.totalPages > 5 && (
                      <>
                        <button
                          onClick={() => handlePageChange(1)}
                          className="px-3 py-1 rounded-lg text-sm font-medium bg-[#1eb5ee]/10 text-[#1eb5ee] hover:bg-[#1eb5ee]/20 transition-colors"
                        >
                          1
                        </button>
      ...
      {showAddModal && (
        ...
        >
          <div className="bg-white rounded-2xl shadow-2xl w-full max-w-lg mx-4 overflow-hidden max-h-[90vh] flex flex-col" onClick={(e) => e.stopPropagation()}>
            <div className="px-6 py-4 bg-[#1eb5ee]">
            ...
            <form onSubmit={handleAddUser} className="p-6 space-y-4 overflow-y-auto">
                  ...
                  <input
                    ...
                    className={`w-full px-4 py-2 rounded-lg border ${
                      formErrors.firstName
                        ? "border-red-500"
                        : "border-[#1eb5ee]/30"
                    } focus:ring-2 focus:ring-[#1eb5ee] focus:border-transparent outline-none`}
                    placeholder="John"
                  />
                  {formErrors.firstName && (
              ...
              <div>
                ...
                <input
                  ...
                  className={`w-full px-4 py-2 rounded-lg border ${
                    formErrors.email ? "border-red-500" : "border-[#1eb5ee]/30"
                  } focus:ring-2 focus:ring-[#1eb5ee] focus:border-transparent outline-none`}
              ...
              <div>
                ...
                <input
                  ...
                  className="w-full px-4 py-2 rounded-lg border border-[#1eb5ee]/30 focus:ring-2 focus:ring-[#1eb5ee] focus:border-transparent outline-none"
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <button
                    ...
                    className="absolute right-3 top-1/2 transform -translate-y-1/2 text-[#64748b] hover:text-[#1eb5ee] transition-colors"
                  >
                    {showPassword ? (
                      <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              ...
              {/* Company Section */}
              <div className="pt-2 border-t border-[#1eb5ee]/20">
              ...
              <div className="flex gap-3 pt-4">
                ...
                <button
                  type="submit"
                  disabled={submitting}
                  className="flex-1 px-4 py-2 bg-[#1eb5ee] text-white rounded-lg hover:bg-[#00bfbf] transition-colors font-medium disabled:opacity-50"
                >
