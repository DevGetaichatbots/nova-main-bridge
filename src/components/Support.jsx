  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        <div className="absolute top-20 left-10 w-32 h-32 bg-gradient-to-br from-sky-400/10 to-sky-500/10 rounded-full animate-float-1"></div>
        <div className="absolute top-40 right-20 w-24 h-24 bg-gradient-to-br from-sky-300/10 to-sky-400/10 rounded-full animate-float-2"></div>
        <div className="absolute bottom-32 left-20 w-20 h-20 bg-gradient-to-br from-sky-500/10 to-sky-600/10 rounded-full animate-float-3"></div>
      </div>
                ...
                <div className="text-center">
                  ...
                  >
                    <svg
                      ...
                      stroke="currentColor"
                      viewBox="0 0 24 24"
                      style={{ color: isDragging ? "#1eb5ee" : "#64748b" }}
                    >
                      <path
                        strokeLinecap="round"
                        strokeLinejoin="round"
